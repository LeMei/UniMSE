...
data = load_pickle(os.path.join(DATA_PATH, 'iemocap_data_0610.pkl'))
...
path = os.path.join(CSV_PATH, 'new-iemocap-label-v4-contexts.csv')
...
to_pickle(train_data, os.path.join(SAVE_PATH, './new_train_por_v4_0610_6c_sep_contexts_v.pkl'))
to_pickle(dev_data, os.path.join(SAVE_PATH, './new_dev_por_v4_0610_6c_sep_contexts_v.pkl'))
to_pickle(test_data, os.path.join(SAVE_PATH, './new_test_por_v4_0610_6c_sep_contexts_v.pkl')) 