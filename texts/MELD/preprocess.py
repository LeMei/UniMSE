...
train_csv = CSV_PATH + '/new-meld-train-label-v4-contexts-with-speaker.csv'
dev_csv = CSV_PATH + '/new-meld-dev-label-v4-contexts-with-speaker.csv'
test_csv = CSV_PATH + '/new-meld-test-label-v4-contexts-with-speaker.csv'
...
to_pickle(train_data, SAVE_PATH + '/new_train_align_v4_0610_sep_contexts_speaker.pkl')
to_pickle(dev_data, SAVE_PATH + '/new_dev_align_v4_0610_sep_contexts_speaker.pkl')
to_pickle(test_data, SAVE_PATH + '/new_test_align_v4_0610_sep_contexts_speaker.pkl')